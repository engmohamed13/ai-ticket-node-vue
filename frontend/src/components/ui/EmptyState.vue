...
/**
 * Generic empty/blank-slate state — used for empty lists and full-page states (403/404).
 * The default icon can be replaced through the `icon` slot; `actions` holds any
